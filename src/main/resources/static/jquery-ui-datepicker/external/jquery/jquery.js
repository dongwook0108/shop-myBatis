...
// Optimize for push.apply( _, NodeList )
                ...
                function Sizzle(selector, context, results, seed) {
                    ...
                    if (typeof selector !== "string" || !selector ||
                            nodeType !== 1 && nodeType !== 9 && nodeType
                            !== 11) {
                            ...
                            if (nodeType !== 11 && (match = rquickExpr.exec(
                                ...
                                if ((m = match[1])) {
                                    ...
                                    if (nodeType === 9) {
                                        ...
                                        // getElementById can match elements by name instead of ID
                                        if (newContext
                                                && (elem = newContext.getElementById(
                                                        m)) &&
...
// Expose support vars for convenience
                ...
                setDocument = Sizzle.setDocument = function (node) {
                    ...
                    if ((parent = document.defaultView) && parent.top
                            !== parent) {
                        // Support: IE 11
                        if (parent.addEventListener) {
                            parent.addEventListener("unload", unloadHandler,
                                    false);
	...
	---------------------------------------------------------------------- */
                ...
                getText = Sizzle.getText = function (elem) {
                    ...
                    } else if (nodeType === 1 || nodeType === 9 || nodeType
                            === 11) {
...
// Easy API for creating new setFilters
                    ...
                    return markFunction(function (seed, results, context, xml) {
                        var temp, i, elem,
                                ...
                                matcherIn = preFilter && (seed || !selector) ?
                                        condense(elems, preMap, preFilter,
                                                context, xml) :
                                        elems,

                                matcherOut = matcher ?
                                        // If we have a postFinder, or filtered seed, or non-seed postFilter or preexisting results,
                                        postFinder || (seed ? preFilter
                ...
                function matcherFromGroupMatchers(elementMatchers,
                    ...
                    var bySet = setMatchers.length > 0,
                            ...
                            superMatcher = function (seed, context, xml,
                                    results, outermost) {
                                var elem, j, matcher,
                                        matchedCount = 0,
                                        i = "0",
                ...
                select = Sizzle.select = function (selector, context, results,
                    ...
                    var i, tokens, token, type, find,
                            compiled = typeof selector === "function"
                                    && selector,
                            match = !seed && tokenize(
                        ...
                        if (list) {
                            ...
                            (function add(args) {
                                jQuery.each(args, function (_, arg) {
                                    ...
                                    } else if (arg && arg.length && jQuery.type(
                                            arg) !== "string") {
                        ...
                        then: function ( /* fnDone, fnFail, fnProgress */) {
                            ...
                            return jQuery.Deferred(function (newDefer) {
                                jQuery.each(tuples, function (i, tuple) {
                                    var fn = jQuery.isFunction(fns[i])
                                            && fns[i];
            ...
            var i = 0,
                    ...
                    updateFunc = function (i, contexts, values) {
                        return function (value) {
                            contexts[i] = this;
                            values[i] = arguments.length > 1 ? slice.call(
                                    arguments) : value;
    ...
    (function () {
        ...
        support.shrinkWrapBlocks = function () {
            ...
            if (typeof div.style.zoom !== "undefined") {
                ...
                div.appendChild(
                        document.createElement("div")).style.width = "5px";
...
// The value/s can optionally be executed if it's a function
    ...
    (function () {
        ...
        support.checkClone = div.cloneNode(true).cloneNode(
                    ...
                    if (this.type === "checkbox" || this.type === "radio") {
                        ...
                        jQuery.event.add(this, "click._change",
                                function (event) {
                                    ...
                                    jQuery.event.simulate("change", this,
                                            event);
                                });
                    }
                    return false;
...
// Replace/restore the type attribute of script elements for safe DOM manipulation
    ...
    function fixCloneNodeIssues(src, dest) {
        ...
        if (nodeName === "script" && dest.text !== src.text) {
            ...
            if (support.html5Clone && (src.innerHTML && !jQuery.trim(
                    dest.innerHTML))) {
        ...
        html: function (value) {
            return access(this, function (value) {
                ...
                if (typeof value === "string" && !rnoInnerhtml.test(value) &&
                        ...
                        (support.leadingWhitespace || !rleadingWhitespace.test(
                                value)) &&
...
// Called only from within defaultDisplay
    ...
    if (window.getComputedStyle) {
        ...
        curCSS = function (elem, name, computed) {
            ...
            if ((ret === "" || ret === undefined) && !jQuery.contains(
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        if (elem.nodeType === 1 && ("height" in props || "width" in props)) {
            ...
            if (checkDisplay === "inline" && jQuery.css(elem, "float")
                ...
                if (!support.inlineBlockNeedsLayout || defaultDisplay(
            ...
            select: {
                ...
                set: function (elem, value) {
                    ...
                    while (i--) {
                        ...
                        if (jQuery.inArray(jQuery.valHooks.option.get(option),
                                values) > -1) {
            ...
            if (attrNames && elem.nodeType === 1) {
                while ((name = attrNames[i++])) {
                    ...
                    if (jQuery.expr.match.bool.test(name)) {
                        ...
                        if (getSetInput && getSetAttribute || !ruseDefault.test(
                                name)) {
                            elem[propName] = false;
