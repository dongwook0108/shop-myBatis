...
public interface MemberMapper {
    ...
    @Update(value = "UPDATE MEMBER SET phone=#{member.phoneNumber}, email=#{member.email}, zipcode=#{member.zipcode}, address=#{member.address}, addressDetail=#{member.addressDetail} WHERE member_id = #{member.id} ")
