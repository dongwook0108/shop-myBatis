...
public class PaginationVo {
    ...
    private int startPage;     // 한 블럭의 시작 페이지: 기본 값 1 // ex) 1 2 3 4 5 일 때 1을 의미.
    ...
    private void setStartPage(final int startPage, final int page, final int pageCount) {
        int calculatedStartPage = startPage + (((page - startPage) / pageCount) * pageCount);
        this.startPage = Math.max(calculatedStartPage, 1);
    }
